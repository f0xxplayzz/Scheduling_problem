        ...
        for (int i = 1; i <= 21; i++) {
            ...
            if (!isSet) {
                if (decisions.isEmpty()) {
                    ...
                    switch (lect) {
                        case 1, 2, 3, 4, 5, 6, 7 -> schedule.inf2019[time][day] = 0;
                        case 8, 9, 10, 11, 12, 13, 14 -> schedule.inf2020[time][day] = 0;
                        case 15, 16, 17, 18, 19, 20, 21 -> schedule.inf2021[time][day] = 0;
                    }
                    switch (lect) {
                        case 1, 8 -> schedule.dozA[time][day] = 0;
                        case 3, 4, 6, 16 -> schedule.dozB[time][day] = 0;
                        case 5, 9, 18 -> schedule.dozC[time][day] = 0;
                        case 20, 21 -> schedule.dozD[time][day] = 0;
                        case 10, 12 -> schedule.dozE[time][day] = 0;
                        case 19 -> schedule.dozF[time][day] = 0;
                        case 13, 14, 15 -> schedule.dozG[time][day] = 0;
                        case 2, 7 -> schedule.dozH[time][day] = 0;
                        case 11, 17 -> schedule.dozI[time][day] = 0;
                    }
                    i = lect - 1;
                }
            } else {
